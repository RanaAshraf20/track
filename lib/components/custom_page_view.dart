...
import 'package:track/components/custom_card.dart';
    ...
    return PageView(
      ...
      children: [
        ...
        CustomCard(
          ...
          dismiss: true,
          cardColor: const Color.fromARGB(255, 3, 86, 251).withOpacity(0.2),
        ...
        CustomCard(
          ...
          subtitle:
              'Track works best with access to your contacts. Easily send and request instant payments for  free',
